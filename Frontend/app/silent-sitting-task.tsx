...
export default function SilentSittingTaskScreen() {
      ...
      <SafeAreaView style={styles.foregroundLayer} edges={['top', 'bottom']}>
        ...
        >
          {!isCompleted && (
            <View style={styles.timerContentWrapper}>
              ...
              <Text style={styles.focusSubtitle}>
                {isPaused ? "Timer Paused" : "Sitting in silence..."}
              </Text>
          ...
          {isCompleted && (
            <View style={styles.successContainer}>
              ...
              <Text style={styles.successText}>Stillness deepened.</Text>
              <Text style={styles.successMessage}>Observe your thoughts without following them and gently return your attention to your breathing whenever your mind wanders.</Text>
              <TouchableOpacity 
        ...
        >
          ...
          <View style={styles.glassPanel}>
            <Text style={styles.title}>Silent Sitting</Text>
            ...
            <View style={styles.descriptionList}>
              <Text style={styles.descLine}>• Find a quiet place and sit comfortably for the next five minutes.</Text>
              <Text style={styles.descLine}>• There is nothing to achieve—simply sit in silence.</Text>
              <Text style={styles.descLine}>• Observe your thoughts without following them and gently return your attention to your breathing whenever your mind wanders.</Text>
              <Text style={styles.descLine}>• Allow yourself to experience a few moments of stillness without distractions.</Text>
            </View>
