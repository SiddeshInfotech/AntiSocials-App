  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View style={[StyleSheet.absoluteFillObject, { opacity: bgShiftAnim }]}>
        <LinearGradient
          colors={['rgba(240, 248, 255, 0.45)', 'rgba(224, 247, 250, 0.55)', 'rgba(255, 255, 255, 0.65)']}
          locations={[0, 0.5, 1]}
          style={StyleSheet.absoluteFillObject}
        />
      </Animated.View>
        ...
        >
          {!isCompleted && (
            <View style={styles.timerContentWrapper}>
              ...
              <Text style={styles.focusSubtitle}>
                {isPaused ? "Timer Paused" : "Relaxing your eyes..."}
              </Text>
          ...
          {isCompleted && (
            <View style={styles.successContainer}>
              ...
              <Text style={styles.successText}>You reset your focus.</Text>
              <Text style={styles.successMessage}>A short eye break helps reduce digital eye strain and refreshes your concentration.</Text>
              <TouchableOpacity 
        ...
        >
          ...
          <View style={styles.glassPanel}>
            ...
            <View style={styles.descriptionList}>
              <Text style={styles.descLine}>• Give your eyes a short break from screens.</Text>
              <Text style={styles.descLine}>• Look away from your phone or computer and focus on a distant object for a few moments.</Text>
              <Text style={styles.descLine}>• Blink naturally, relax your eye muscles, and take a few slow breaths.</Text>
              <Text style={styles.descLine}>• A short eye break helps reduce digital eye strain and refreshes your concentration.</Text>
            </View>
