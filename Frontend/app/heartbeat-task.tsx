...
export default function HeartbeatTaskScreen() {
  ...
  // Mascot Floating & Heart beating pulse animation
  ...
  useEffect(() => {
    ...
    // Mascot animations (Gentle floating / heartbeat pulse)
    Animated.loop(
      Animated.sequence([
    ...
    // Heartbeat double pulse scaling effect
    Animated.loop(
      Animated.sequence([
        Animated.timing(mascotScaleAnim, { toValue: 1.10, duration: 150, easing: Easing.out(Easing.ease), useNativeDriver: true }),
        Animated.timing(mascotScaleAnim, { toValue: 0.95, duration: 150, easing: Easing.in(Easing.ease), useNativeDriver: true }),
        Animated.timing(mascotScaleAnim, { toValue: 1.05, duration: 150, easing: Easing.out(Easing.ease), useNativeDriver: true }),
        Animated.timing(mascotScaleAnim, { toValue: 0.95, duration: 600, easing: Easing.in(Easing.ease), useNativeDriver: true }),
      ])
    ).start();
    ...
    try {
      ...
      if (token) {
        const response = await fetch(`${API_BASE_URL}/api/tasks/complete`, {
          ...
          body: JSON.stringify({ task_name: 'Notice heartbeat' })
        });
      ...
      <SafeAreaView style={styles.foregroundLayer} edges={['top', 'bottom']}>
        ...
        >
          {!isCompleted && (
            <View style={styles.timerContentWrapper}>
              ...
              <Text style={styles.focusSubtitle}>
                {isPaused ? "Timer Paused" : "Listening inward..."}
              </Text>
          ...
          {isCompleted && (
            <View style={styles.successContainer}>
              ...
              <Text style={styles.successText}>You tuned inward.</Text>
              <Text style={styles.successMessage}>Place your hand on your chest or wrist and simply observe your heartbeat without trying to change it.</Text>
              <TouchableOpacity 
        ...
        >
          ...
          <View style={styles.glassPanel}>
            <Text style={styles.title}>Notice heartbeat</Text>
            ...
            <View style={styles.descriptionList}>
              <Text style={styles.descLine}>• Pause for a moment and gently notice your heartbeat.</Text>
              <Text style={styles.descLine}>• Place your hand on your chest or wrist and simply observe your heartbeat without trying to change it.</Text>
              <Text style={styles.descLine}>• Take slow, natural breaths and bring your attention inward.</Text>
              <Text style={styles.descLine}>• This simple practice builds self-awareness and helps calm the mind.</Text>
            </View>
