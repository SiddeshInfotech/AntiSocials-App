    ...
    try {
      ...
      if (token) {
        const response = await fetch(`${API_BASE_URL}/api/tasks/complete`, {
          ...
          body: JSON.stringify({ task_name: 'Observe urge to check phone' })
        });
      ...
      <SafeAreaView style={styles.foregroundLayer} edges={['top', 'bottom']}>
        ...
        >
          {!isCompleted && (
            <View style={styles.timerContentWrapper}>
              ...
              <Text style={styles.focusSubtitle}>
                {isPaused ? "Timer Paused" : "Observing the impulse..."}
              </Text>
          ...
          {isCompleted && (
            <View style={styles.successContainer}>
              ...
              <Text style={styles.successText}>You noticed the impulse.</Text>
              <Text style={styles.successMessage}>Building awareness is the first step toward healthier digital habits.</Text>
              <TouchableOpacity 
        ...
        >
          ...
          <View style={styles.glassPanel}>
            <Text style={styles.title}>Observe urge to check phone</Text>
            ...
            <View style={styles.descriptionList}>
              <Text style={styles.descLine}>• For the next 5 minutes, simply notice whenever you feel the urge to check your phone.</Text>
              <Text style={styles.descLine}>• Do not judge yourself or immediately act on the impulse.</Text>
              <Text style={styles.descLine}>• Take a deep breath, acknowledge the feeling, and gently return your attention to the present moment.</Text>
              <Text style={styles.descLine}>• Building awareness is the first step toward healthier digital habits.</Text>
            </View>
...
// Importing AppState at runtime if needed, but it is better to resolve compile imports correctly.
// Let's import AppState at the top of the file. To avoid issues, let's include it in the style layout too.
