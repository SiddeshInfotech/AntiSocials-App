...
const TASK_DURATION = 3600; // 1 Hour (3600 seconds)
      ...
      <SafeAreaView style={styles.foregroundLayer} edges={['top', 'bottom']}>
        ...
        >
          {!isCompleted && (
            <View style={styles.timerContentWrapper}>
              ...
              <Text style={styles.focusSubtitle}>
                {isPaused ? "Timer Paused" : "Enjoying digital stillness..."}
              </Text>
          ...
          {isCompleted && (
            <View style={styles.successContainer}>
              ...
              <Text style={styles.successText}>You disconnected.</Text>
              <Text style={styles.successMessage}>Giving your mind a break from constant media consumption helps improve focus and mental clarity.</Text>
              <TouchableOpacity 
        ...
        >
          ...
          <View style={styles.glassPanel}>
            <Text style={styles.title}>No Media</Text>
            ...
            <View style={styles.descriptionList}>
              <Text style={styles.descLine}>• Take a one-hour break from all forms of digital media.</Text>
              <Text style={styles.descLine}>• Avoid social media, YouTube, OTT platforms, news, short videos, and entertainment content.</Text>
              <Text style={styles.descLine}>• Use this time to reconnect with yourself or do offline activities like reading, walking, or journaling.</Text>
              <Text style={styles.descLine}>• A break from media consumption helps improve focus and clarity.</Text>
            </View>
